...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 vedic-bg-pattern">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2.5">
            <div className="flex size-10 items-center justify-center rounded-lg bg-primary/10 vedic-glow">
              <BookOpen className="size-6 text-primary" />
            </div>
            <span className="text-2xl font-bold vedic-gradient-text">
              VedicGPT
            </span>
          </Link>
          <p className="mt-3 text-muted-foreground">
            Sign in to bookmark verses and track your progress
          </p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground/50">
          <span className="sanskrit-text text-xs">
            तमसो मा ज्योतिर्गमय
          </span>
          <br />
